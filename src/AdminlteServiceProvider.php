...
class AdminlteServiceProvider extends ServiceProvider
{
    ...
    public function boot(Adminlte $extension)
    {
        ...
        if ($this->app->runningInConsole() && $assets = $extension->assets()) {
            $this->publishes(
                [$assets => public_path('vendor/wenxuanjun/adminlte3')],
                'adminlte'
            );
        }
        ...
        $this->app->booted(function () {
            ...
            Admin::baseCss([
                'vendor/wenxuanjun/adminlte3/plugins/font-awesome/css/font-awesome.min.css',
                'vendor/wenxuanjun/adminlte3/plugins/glyphicons/css/glyphicons.css',
                'vendor/wenxuanjun/adminlte3/dist/css/adminlte.min.css',
                ...
                'vendor/wenxuanjun/adminlte3/dist/css/app.css'
            ]);

            Admin::baseJs([
                'vendor/wenxuanjun/adminlte3/plugins/bootstrap/js/bootstrap.bundle.min.js',
                'vendor/wenxuanjun/adminlte3/plugins/slimScroll/jquery.slimscroll.min.js',
                'vendor/wenxuanjun/adminlte3/plugins/fastclick/fastclick.js',
                'vendor/wenxuanjun/adminlte3/dist/js/adminlte.min.js',
                ...
                'vendor/wenxuanjun/adminlte3/dist/js/app.js',
                'vendor/wenxuanjun/adminlte3/dist/js/demo.js',
            ]);
        });
    }
}
